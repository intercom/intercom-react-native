...
echo ANDROID_INTERCOM_APP_ID=$ANDROID_INTERCOM_REACT_NATIVE_APP_ID >>.env
echo ANDROID_INTERCOM_KEY=$ANDROID_INTERCOM_REACT_NATIVE_KEY >>.env
echo CAROUSEL_ID=$CAROUSEL_ID >>.env
echo SURVEY_ID=$SURVEY_ID >>.env
echo EVENT_NAME=$EVENT_NAME >>.env
echo ARTICLE_ID=$ARTICLE_ID_REACT_NATIVE >>.env
